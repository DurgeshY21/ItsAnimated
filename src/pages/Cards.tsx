...
const Cards = () => {
    ...
    const cards = [
        {
            id: 'profile-card',
            name: 'Profile Card',
            description: 'User profile with banner, avatar, and stats',
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 overflow-hidden hover:shadow-xl transition-all duration-300">
            ...
            code: `<div className="bg-white rounded-2xl border overflow-hidden hover:shadow-xl transition-all">
    <div className="h-20 bg-gradient-to-r from-blue-400 to-purple-500"></div>
    <div className="px-6 pb-6 -mt-10">
                        <div className="w-20 h-20 rounded-full border-4 border-white mx-auto mb-4 overflow-hidden">
                            <img src="avatar1" alt="Profile" className="w-full h-full object-cover" />
                        </div>
        <h3 className="text-center font-bold mb-1">Sarah Smith</h3>
        <p className="text-center text-sm text-neutral-500 mb-4">Freelance Web Designer</p>
        ...
        },
        {
            id: 'blog-card',
            name: 'Blog Card',
            description: 'Content card with image, tag, and metadata',
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            code: `<div className="bg-white rounded-2xl border overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all">
    <div className="relative h-40 bg-gradient-to-br from-orange-200 to-pink-200">
        <span className="absolute top-3 right-3 px-3 py-1 bg-purple-600 text-white text-xs font-semibold rounded-full">Tag</span>
    </div>
    <div className="p-5">
        <h3 className="font-bold mb-2 text-lg">Title</h3>
        <p className="text-sm text-neutral-600 mb-4">Description text...</p>
        ...
        },
        {
            ...
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 overflow-hidden hover:shadow-xl transition-all duration-300 group">
                    <div className="relative h-48 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 flex items-center justify-center">
                        ...
                        <button className="absolute top-3 right-3 p-2 bg-white dark:bg-neutral-700 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <div className="p-5">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button className="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors text-sm font-semibold">Add to Cart</button>
                        </div>
                    </div>
                </div>
            ),
            code: `<div className="bg-white rounded-2xl border overflow-hidden hover:shadow-xl transition-all group">
    <div className="relative h-48 bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center">
        <div className="w-24 h-24 bg-white rounded-2xl shadow-lg group-hover:scale-110 transition-transform"></div>
    </div>
    <div className="p-5">
        <h3 className="font-bold mb-1">Product Name</h3>
        <div className="flex items-center justify-between">
            <span className="text-2xl font-bold">$99</span>
            <button className="px-4 py-2 bg-primary-600 text-white rounded-lg">Add to Cart</button>
        </div>
    </div>
</div>`,
        },
        {
            ...
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-lg transition-all">
            ...
            code: `<div className="bg-white rounded-2xl border p-6 hover:shadow-lg transition-all">
    <div className="flex items-center justify-between mb-4">
        <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center">
            <!-- Icon -->
        </div>
        <span className="px-2 py-1 bg-green-100 text-green-600 text-xs font-semibold rounded-full">+12.5%</span>
    </div>
    <div>
        ...
        },
        {
            ...
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-xl transition-all">
            ...
            code: `<div className="bg-white rounded-2xl border p-6 hover:shadow-xl transition-all">
    <div className="flex items-center gap-1 mb-4">
        <!-- Stars -->
    </div>
    ...
    <div className="flex items-center gap-3">
        ...
        },
        {
            id: 'feature-card',
            name: 'Feature Card',
            description: 'Feature showcase with icon and description',
            preview: (
                <div className="w-full bg-gradient-to-br from-primary-50 to-purple-50 dark:from-primary-900/20 dark:to-purple-900/20 rounded-2xl border border-primary-200 dark:border-primary-800 p-6 hover:shadow-lg hover:scale-105 transition-all">
            ...
            code: `<div className="bg-gradient-to-br from-primary-50 to-purple-50 rounded-2xl border border-primary-200 p-6 hover:shadow-lg hover:scale-105 transition-all">
    <div className="w-14 h-14 bg-primary-600 rounded-2xl flex items-center justify-center mb-4">
        <!-- Icon -->
    </div>
    ...
    <p className="text-sm text-neutral-600">Feature description...</p>
        ...
        },
        {
            id: 'pricing-card',
            name: 'Pricing Card',
            description: 'Pricing plan with features list',
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border-2 border-primary-500 dark:border-primary-600 p-6 hover:shadow-2xl transition-all relative overflow-hidden">
                    ...
                    <button className="w-full py-3 bg-primary-600 text-white rounded-lg font-semibold hover:bg-primary-700 transition-colors">Get Started</button>
                </div>
            ),
            code: `<div className="bg-white rounded-2xl border-2 border-primary-500 p-6 hover:shadow-2xl transition-all">
    ...
    <ul className="space-y-3 mb-6">
        <li className="flex items-center gap-2">Feature 1</li>
    </ul>
    <button className="w-full py-3 bg-primary-600 text-white rounded-lg">Get Started</button>
</div>`,
        },
        {
            id: 'glassmorphism-card',
            name: 'Glassmorphism Card',
            description: 'Glass effect card with backdrop blur',
            preview: (
                <div className="w-full h-48 bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-xl rounded-2xl border border-white/20 p-6 hover:bg-gradient-to-br hover:from-purple-500/30 hover:to-pink-500/30 transition-all">
            ...
            code: `<div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-xl rounded-2xl border border-white/20 p-6">
    ...
    <p className="text-white/80 text-sm">Description</p>
        ...
        },
        {
            ...
            description: 'Social post card with engagement metrics',
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 overflow-hidden hover:shadow-xl transition-all">
    ...
    <div className="p-4 flex items-center gap-3 border-b">
        ...
        <div>
            ...
            <p className="text-xs text-neutral-500">Time ago</p>
        </div>
    </div>
    <div className="p-4">
        ...
        },
        {
            id: 'event-card',
            name: 'Event Card',
            description: 'Event card with date and location',
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 overflow-hidden hover:shadow-xl transition-all">
                    ...
                    <div className="p-5">
                        ...
                        <button className="w-full py-2 bg-primary-600 text-white rounded-lg font-semibold hover:bg-primary-700 transition-colors text-sm">Register Now</button>
                    </div>
                </div>
            ),
            code: `<div className="bg-white rounded-2xl border overflow-hidden hover:shadow-xl transition-all">
    ...
    <div className="p-5">
        <h3 className="font-bold mb-2 text-lg">Event Title</h3>
        <button className="w-full py-2 bg-primary-600 text-white rounded-lg">Register</button>
    </div>
</div>`,
        },
        {
            id: 'team-card',
            name: 'Team Card',
            description: 'Team member card with social links',
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 p-6 text-center hover:shadow-xl hover:-translate-y-1 transition-all">
                    ...
                    <div className="flex justify-center gap-3">
                        <button className="w-9 h-9 rounded-full bg-neutral-100 dark:bg-neutral-700 flex items-center justify-center hover:bg-primary-100 dark:hover:bg-primary-900/30 transition-colors">
            ...
            code: `<div className="bg-white rounded-2xl border p-6 text-center hover:shadow-xl hover:-translate-y-1 transition-all">
    <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
        <img src="avatar" alt="Profile" className="w-full h-full object-cover" />
    </div>
    <h3 className="font-bold mb-1 text-lg">Name</h3>
    <p className="text-sm text-primary-600 mb-3">Role</p>
    <div className="flex justify-center gap-3">
        <!-- Social icons -->
    </div>
</div>`,
        },
        {
            ...
            description: 'Notification card with action buttons',
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 p-5 hover:shadow-lg transition-all">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex gap-2">
                                <button className="px-3 py-1.5 bg-primary-600 text-white rounded-lg text-xs font-semibold hover:bg-primary-700 transition-colors">View</button>
                                <button className="px-3 py-1.5 bg-neutral-100 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-300 rounded-lg text-xs font-semibold hover:bg-neutral-200 dark:hover:bg-neutral-600 transition-colors">Dismiss</button>
                            </div>
                        </div>
                    </div>
                </div>
            ),
            code: `<div className="bg-white rounded-2xl border p-5 hover:shadow-lg transition-all">
    <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
            ...
            <p className="text-sm text-neutral-600 mb-3">Message text...</p>
            <div className="flex gap-2">
                <button className="px-3 py-1.5 bg-primary-600 text-white rounded-lg text-xs">Action</button>
            </div>
        </div>
    </div>
</div>`,
        },
        {
            ...
            preview: (
                <div className="w-full h-64 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl relative overflow-hidden group hover:scale-105 transition-transform cursor-pointer">
            ...
            code: `<div className="w-full h-64 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl relative overflow-hidden group hover:scale-105 transition-transform">
    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
    <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
        <span className="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-xs mb-2">Category</span>
        ...
        },
        {
            id: 'dashboard-card',
            name: 'Dashboard Card',
            description: 'Dashboard widget with chart area',
            preview: (
                <div className="w-full bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-lg transition-all">
                    <div className="flex items-center justify-between mb-4">
                        <div>
    ...
    <div className="h-20 bg-gradient-to-t from-green-100 to-transparent rounded-lg">
        <!-- Chart bars -->
    </div>
</div>`,
        },
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
                        ...
                        <br />Click any card to view details and code.
                    </p>
                </div>
